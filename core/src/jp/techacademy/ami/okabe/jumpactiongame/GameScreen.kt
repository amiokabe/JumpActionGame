...
class GameScreen(private val mGame: JumpActionGame): ScreenAdapter() {
    ...
    private val mSound1: Sound
    private val mSound2: Sound
    private val mSound3: Sound
    private val mSound4: Sound
    private val mSound5: Sound
    ...
    init {
        mSound1 = Gdx.audio.newSound(Gdx.files.internal("enemySound.mp3"))
        mSound2 = Gdx.audio.newSound(Gdx.files.internal("touchSound.mp3"))
        mSound3 = Gdx.audio.newSound(Gdx.files.internal("ScreenChangeSound.mp3"))
        mSound4 = Gdx.audio.newSound(Gdx.files.internal("UfoSound.mp3"))
        mSound5 = Gdx.audio.newSound(Gdx.files.internal("GameoverSound.mp3"))
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.ami.okabe.jumpactiongame")
    ...
    private fun updateGameClear() {
        if (Gdx.input.justTouched()) {
            mSound3.play()
            mSound3.dispose()
            mGame.screen = ClearScreen(mGame, mScore)
        }
    }
