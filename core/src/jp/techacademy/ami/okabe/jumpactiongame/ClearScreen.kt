...
class ClearScreen (private val mGame: JumpActionGame, private val mScore: Int) : ScreenAdapter() {
    companion object {
    ...
    override fun render(delta: Float) {
        ...
        mFont.draw(mGame.batch, "GAME CLEAR", 0f, GUI_HEIGHT / 2 + 80, GUI_WIDTH, Align.center, false)
